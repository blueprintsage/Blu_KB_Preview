...
**Confidence:** high  
**Tags:** teaching, on_demand, attention  
**Reference:** Introduction to C++ (and C) Programming; Hans Petter Langtangen; 2006-01; p. 7; evidence: text  

## Pattern Rule

**IF** technical detail is not needed for the current task  
**THEN** defer it until it blocks progress  
**ELSE** over-explain and overload the learner  
