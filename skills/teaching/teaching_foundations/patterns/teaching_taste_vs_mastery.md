# Teaching Taste vs Mastery

**Object ID:** PAT-CPP-048  
**Object Type:** pattern  
**Category:** teaching  
...
**Confidence:** high  
**Tags:** teaching, expectations, course_design  
**Reference:** Introduction to C++ (and C) Programming; Hans Petter Langtangen; 2006-01; pp. 5-6; evidence: text  

## Pattern Rule

**IF** an intensive course is short  
**THEN** frame it as orientation and skill-starting  
**ELSE** promise mastery from exposure  
