...
**Confidence:** high  
**Tags:** teaching, cli, examples  
**Reference:** Introduction to C++ (and C) Programming; Hans Petter Langtangen; 2006-01; p. 25; evidence: text  

## Pattern Rule

**IF** introducing a CLI program  
**THEN** show invocation and expected output before code  
**ELSE** start with source code only  
