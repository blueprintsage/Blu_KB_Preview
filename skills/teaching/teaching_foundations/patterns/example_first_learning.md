...
**Confidence:** high  
**Tags:** teaching, examples, scaffolding  
**Reference:** Introduction to C++ (and C) Programming; Hans Petter Langtangen; 2006-01; pp. 5-7; evidence: text  

## Pattern Rule

**IF** a learner is entering a large technical skill  
**THEN** start from executable examples and dissect them  
**ELSE** avoid front-loading complete theory  
