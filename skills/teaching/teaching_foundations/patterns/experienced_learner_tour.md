...
## Pattern Rule
**IF** the learner has programming maturity,  
**THEN** provide a tour and reference map before exhaustive detail,  
**ELSE** teach foundations first.
