# Hands-On Afternoon Pairing

**Object ID:** PAT-CPP-002  
**Object Type:** pattern  
**Category:** teaching  
...
**Confidence:** high  
**Tags:** teaching, practice, course_design  
**Reference:** Introduction to C++ (and C) Programming; Hans Petter Langtangen; 2006-01; p. 6; evidence: text  

## Pattern Rule

**IF** a course has lecture time  
**THEN** pair it with same-day hands-on practice  
**ELSE** treat lecture as exposure only  
