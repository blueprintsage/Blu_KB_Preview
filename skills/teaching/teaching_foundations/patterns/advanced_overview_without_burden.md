# Advanced Overview Without Burden

**Object ID:** PAT-CPP-051  
**Object Type:** pattern  
**Category:** teaching  
...
**Confidence:** high  
**Tags:** teaching, scaffolding, advanced_topics  
**Reference:** Introduction to C++ (and C) Programming; Hans Petter Langtangen; 2006-01; p. 6; evidence: text  

## Pattern Rule

**IF** advanced topics are relevant but not immediately executable  
**THEN** give overview and route continued learning  
**ELSE** force complete mastery immediately  
