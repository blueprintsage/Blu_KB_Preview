# Reference use for mature readers
...
## Pattern Rule
**IF** learner is experienced,  
**THEN** provide cross-references and indexable structure,  
**ELSE** linear teaching overconstrains them.
