# Exception Handling Validation Rule
...
## Pattern Rule
**IF** using exception handling in production code,  
**THEN** state its contract and failure mode,  
**ELSE** correctness depends on memory.
...
### Variant absorbed: Exception boundaries in generic components
For template-based components, define whether invalid use is compile-time failure, exception, null result, or rejected registration. Source: Modern C++ Design, pp. 152-190.
