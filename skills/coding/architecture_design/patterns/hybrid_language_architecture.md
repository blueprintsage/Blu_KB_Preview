...
**Confidence:** high  
**Tags:** architecture, interop, performance  
**Reference:** Introduction to C++ (and C) Programming; Hans Petter Langtangen; 2006-01; p. 13; evidence: text  

## Pattern Rule

**IF** a project needs usability and speed  
**THEN** use a high-level language for orchestration and C++ for intensive kernels  
**ELSE** force every layer into C++  
