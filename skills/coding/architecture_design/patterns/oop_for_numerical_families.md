# OOP For Numerical Families

**Object ID:** PAT-CPP-068  
**Object Type:** pattern  
**Category:** coding  
...
**Confidence:** high  
**Tags:** oop, numerics, solvers  
**Reference:** Introduction to C++ (and C) Programming; Hans Petter Langtangen; 2006-01; pp. 290-350; evidence: text  

## Pattern Rule

**IF** several solvers share a concept  
**THEN** define an interface/base abstraction for the family  
**ELSE** copy a solver for each equation type  
