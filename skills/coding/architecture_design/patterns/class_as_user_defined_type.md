...
**Confidence:** high  
**Tags:** classes, oop, abstraction  
**Reference:** Introduction to C++ (and C) Programming; Hans Petter Langtangen; 2006-01; pp. 95-150; evidence: text  

## Pattern Rule

**IF** a domain concept has data plus behavior  
**THEN** model it as a class with an explicit public interface  
**ELSE** scatter data and functions without ownership  
