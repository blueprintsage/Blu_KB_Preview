# Encapsulate Allocation In Types

**Object ID:** PAT-CPP-031  
**Object Type:** pattern  
**Category:** coding  
...
**Confidence:** high  
**Tags:** encapsulation, raii, containers  
**Reference:** Introduction to C++ (and C) Programming; Hans Petter Langtangen; 2006-01; pp. 82-84; evidence: text  

## Pattern Rule

**IF** a data structure needs dynamic storage  
**THEN** hide allocation/deallocation inside a type  
**ELSE** make users manage every storage detail  
