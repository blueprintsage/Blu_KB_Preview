...
**Confidence:** high  
**Tags:** headers, modularity, classes  
**Reference:** Introduction to C++ (and C) Programming; Hans Petter Langtangen; 2006-01; pp. 145-220; evidence: text  

## Pattern Rule

**IF** a class grows beyond one file  
**THEN** place declarations and definitions in clear units  
**ELSE** force every user to read implementation details  
