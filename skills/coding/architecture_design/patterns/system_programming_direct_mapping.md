# System programming direct mapping
...
## Pattern Rule
**IF** code must touch hardware or tight resources,  
**THEN** preserve direct mapping and explicit costs,  
**ELSE** abstractions may violate constraints.
