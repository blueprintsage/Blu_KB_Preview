# Polymorphism For Solver Choice

**Object ID:** PAT-CPP-071  
**Object Type:** pattern  
**Category:** coding  
...
**Confidence:** high  
**Tags:** polymorphism, solvers, oop  
**Reference:** Introduction to C++ (and C) Programming; Hans Petter Langtangen; 2006-01; pp. 290-350; evidence: text  

## Pattern Rule

**IF** runtime solver selection is needed  
**THEN** use an interface/polymorphic boundary  
**ELSE** scatter conditionals across calling code  
