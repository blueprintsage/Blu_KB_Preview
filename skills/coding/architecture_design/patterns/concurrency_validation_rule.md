...
## Pattern Rule
**IF** using concurrency in production code,  
...
### Variant absorbed: Threading as explicit policy
For reusable components, thread-safety is a design axis that should be explicit rather than hidden behind a universal interface. Source: Modern C++ Design, pp. 26-28, 143-146, 276-285.
