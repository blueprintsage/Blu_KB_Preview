# Smart pointer ownership Workflow
...
## Objective
Apply smart pointer ownership workflow as a real C++ workflow.
...
### Variant absorbed: Ownership policy matrix
Add a step before implementation: classify ownership, null behavior, conversion behavior, storage model, and threading assumptions separately. Source: Modern C++ Design, pp. 152-185.
