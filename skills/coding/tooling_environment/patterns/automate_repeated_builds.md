...
**Confidence:** high  
**Tags:** automation, build, scripts  
**Reference:** Introduction to C++ (and C) Programming; Hans Petter Langtangen; 2006-01; pp. 34-38, 42; evidence: text  

## Pattern Rule

**IF** manual compile commands repeat  
**THEN** capture them in a build script or build system  
**ELSE** retype commands by hand  
