...
**Confidence:** high  
**Tags:** linking, libraries, build  
**Reference:** Introduction to C++ (and C) Programming; Hans Petter Langtangen; 2006-01; pp. 40-41; evidence: text  

## Pattern Rule

**IF** linking reusable compiled code  
**THEN** distinguish executable, static library, and shared library  
**ELSE** treat all compiled outputs as the same  
