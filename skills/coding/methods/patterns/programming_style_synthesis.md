...
## Pattern Rule
**IF** solving nontrivial C++ problems,  
**THEN** combine procedural, abstraction, OOP, and generic styles,  
**ELSE** one-style purity weakens design.
