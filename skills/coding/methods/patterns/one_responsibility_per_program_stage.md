# One Responsibility Per Program Stage

**Object ID:** PAT-CPP-042  
**Object Type:** pattern  
**Category:** coding  
**Subcategory:** methods  
...
**Confidence:** high  
**Tags:** workflow, pipeline, modularity  
**Reference:** Introduction to C++ (and C) Programming; Hans Petter Langtangen; 2006-01; pp. 46, 60; evidence: text  

## Pattern Rule

**IF** writing a small utility  
**THEN** organize as parse-open-process-close  
**ELSE** let the loop own every responsibility  
