# Language Boundary Benchmark

**Object ID:** PAT-CPP-067  
**Object Type:** pattern  
**Category:** coding  
**Subcategory:** methods  
...
**Confidence:** high  
**Tags:** benchmarking, language_choice, performance  
**Reference:** Introduction to C++ (and C) Programming; Hans Petter Langtangen; 2006-01; pp. 8-13, 260-290; evidence: text  

## Pattern Rule

**IF** choosing between C, C++, Fortran, Python, Java  
**THEN** compare realistic workloads and interop needs  
**ELSE** generalize from toy timing claims  
