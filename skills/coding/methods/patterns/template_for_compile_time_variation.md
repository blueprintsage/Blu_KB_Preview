# Template for compile-time variation
...
## Pattern Rule
**IF** variation is known at compile time,  
**THEN** use templates,  
**ELSE** runtime polymorphism may add needless overhead.
...
### Variant absorbed: Policy and type-list metaprogramming
Extends compile-time variation beyond containers into design-structure generation, type selection, and policy matrices. Prefer concepts, traits, and variadic templates for modern implementations. Source: Modern C++ Design, pp. 19-73.


## PASS Variant Absorption — Boost C++ Application Development Cookbook

- Absorbed variant: Boost.TypeTraits/MPL to concepts migration
