# Metaprogramming only when payoff exists
...
## Pattern Rule
**IF** compile-time computation reduces real complexity or cost,  
**THEN** use metaprogramming,  
**ELSE** it becomes cleverness tax.
