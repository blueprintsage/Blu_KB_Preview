# Modernize While Preserving Lesson

**Object ID:** PAT-CPP-081  
**Object Type:** pattern  
**Category:** coding  
**Subcategory:** methods  
...
**Confidence:** high  
**Tags:** modernization, source_mining, patterns  
**Reference:** Introduction to C++ (and C) Programming; Hans Petter Langtangen; 2006-01; whole PDF; evidence: text  

## Pattern Rule

**IF** a dated programming source contains a still-useful lesson  
**THEN** preserve the concept and update the execution path  
**ELSE** reject the whole source because syntax is old  
