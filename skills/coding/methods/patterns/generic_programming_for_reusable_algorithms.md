# Generic programming for reusable algorithms
...
## Pattern Rule
**IF** operations depend on requirements rather than concrete types,  
**THEN** use generic programming,  
**ELSE** algorithms duplicate.
