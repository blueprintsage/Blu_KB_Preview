# Compiled Language Selection

**Object ID:** PAT-CPP-004  
**Object Type:** pattern  
**Category:** coding  
**Subcategory:** methods  
...
**Confidence:** high  
**Tags:** performance, language_choice, numerics  
**Reference:** Introduction to C++ (and C) Programming; Hans Petter Langtangen; 2006-01; pp. 8, 13; evidence: text  

## Pattern Rule

**IF** performance-critical numerical code is required  
**THEN** consider C++ for the hot path  
**ELSE** use higher-level language alone without measuring  
