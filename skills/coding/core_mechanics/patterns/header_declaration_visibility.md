# Header Declaration Visibility

**Object ID:** PAT-CPP-009  
**Object Type:** pattern  
**Category:** coding  
...
**Confidence:** high  
**Tags:** headers, compiler, c  
**Reference:** Introduction to C++ (and C) Programming; Hans Petter Langtangen; 2006-01; pp. 26-27, 43-44; evidence: text  

## Pattern Rule

**IF** a function or library symbol is used  
**THEN** include the header that declares it  
**ELSE** rely on accidental transitive includes  
