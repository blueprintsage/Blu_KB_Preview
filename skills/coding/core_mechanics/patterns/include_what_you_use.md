...
**Confidence:** high  
**Tags:** headers, style, modern_cpp  
**Reference:** Introduction to C++ (and C) Programming; Hans Petter Langtangen; 2006-01; pp. 26-27; evidence: text  

## Pattern Rule

**IF** a source file depends on a declaration  
**THEN** include the direct header for that declaration  
**ELSE** depend on another header to include it accidentally  
