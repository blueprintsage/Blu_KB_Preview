...
## Pattern Rule
**IF** a constraint can be expressed in types,  
**THEN** let the compiler check it,  
**ELSE** errors move to runtime.
...
### Variant absorbed: Compile-time assertion modernization
Historical compile-time checker idioms map to modern `static_assert`, standard type traits, and concepts. Keep diagnostics close to the template boundary. Source: Modern C++ Design, pp. 32-44.
