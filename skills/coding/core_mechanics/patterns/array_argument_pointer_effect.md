# Array Argument Pointer Effect

**Object ID:** PAT-CPP-030  
**Object Type:** pattern  
**Category:** coding  
...
**Confidence:** high  
**Tags:** arrays, functions, pointers  
...
**THEN** remember changes are visible through pointers  
**ELSE** assume pass-by-value protects array contents  
