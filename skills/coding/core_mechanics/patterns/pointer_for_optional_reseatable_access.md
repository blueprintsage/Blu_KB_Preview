# Pointer for optional/reseatable access
...
## Pattern Rule
**IF** an argument may be absent or reseated,  
**THEN** use a pointer or smart pointer,  
**ELSE** reference semantics mislead.
...
- Absorbed variant: Boost.Optional absence contract
