...
**Confidence:** high  
**Tags:** floating_point, precision, types  
**Reference:** Introduction to C++ (and C) Programming; Hans Petter Langtangen; 2006-01; pp. 29, 58; evidence: text  

## Pattern Rule

**IF** floating-point accuracy matters  
**THEN** choose float/double deliberately and document precision  
**ELSE** let implicit conversion decide silently  
