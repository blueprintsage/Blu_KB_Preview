# Modern Conversion Safety

**Object ID:** PAT-CPP-043  
**Object Type:** pattern  
**Category:** coding  
...
**Confidence:** high  
**Tags:** conversion, modern_cpp, safety  
**Reference:** Introduction to C++ (and C) Programming; Hans Petter Langtangen; 2006-01; pp. 25-31, 58; evidence: text  

## Pattern Rule

**IF** converting command-line text in modern C++  
**THEN** use std::from_chars/std::stod with error handling  
**ELSE** use atof/atoi without validation  
