# Control Flow Mirrors Decision Flow

object_id: control_flow_mirrors_decision_flow
object_type: pattern
category: coding
...
## Pattern Rule
**IF** a task has distinct cases  
**THEN** encode those cases explicitly with branch or loop structure  
**ELSE** the program hides its own logic
