...
## Pattern Rule
**IF** using templates in production code,  
...
### Variant absorbed: Template validation through constraints
Adds a modernized rule: use `static_assert`, traits, and concepts to make template assumptions visible instead of relying on deep instantiation errors. Source: Modern C++ Design, pp. 32-44.
