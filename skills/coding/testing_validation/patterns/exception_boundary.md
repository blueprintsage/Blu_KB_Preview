...
**Confidence:** high  
**Tags:** exceptions, errors, api_design  
**Reference:** Introduction to C++ (and C) Programming; Hans Petter Langtangen; 2006-01; p. 10; evidence: text  

## Pattern Rule

**IF** an operation can fail in modern C++  
**THEN** choose exceptions or error values consistently at the boundary  
**ELSE** mix failure styles unpredictably  
