...
**Confidence:** high  
**Tags:** testing, numerics, debugging  
**Reference:** Introduction to C++ (and C) Programming; Hans Petter Langtangen; 2006-01; pp. 68, 87; evidence: text  

## Pattern Rule

**IF** building numerical array code  
**THEN** verify on small dimensions before scaling  
**ELSE** trust a large run with no inspectable expected result  
...
- PPP variant: before broad testing theory, use small calculator, parser, numeric, and container examples to force concrete expected behavior.
