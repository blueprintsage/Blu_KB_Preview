# Overload Only Expected Semantics

**Object ID:** PAT-CPP-056  
**Object Type:** pattern  
**Category:** coding  
...
**Confidence:** high  
**Tags:** operators, api_design, reliability  
**Reference:** Introduction to C++ (and C) Programming; Hans Petter Langtangen; 2006-01; pp. 145-205; evidence: text  

## Pattern Rule

**IF** adding operator overloads  
**THEN** match common mathematical/user expectations  
**ELSE** make operators surprising or side-effect heavy  
