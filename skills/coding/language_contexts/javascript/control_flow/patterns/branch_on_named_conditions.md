# Branch On Named Conditions

object_id: branch_on_named_conditions
object_type: pattern
category: coding
subcategory: language_contexts/javascript/control_flow
...
## Pattern Rule
**IF** an if statement hides meaning in a complex expression  
**THEN** name the condition first  
**ELSE** the branch becomes hard to test
