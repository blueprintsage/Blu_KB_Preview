# Algorithm Before Loop

**Object ID:** PAT-CPP-063  
**Object Type:** pattern  
**Category:** coding  
...
**Confidence:** high  
**Tags:** stl, algorithms, modern_cpp  
**Reference:** Introduction to C++ (and C) Programming; Hans Petter Langtangen; 2006-01; pp. 230-260; evidence: text  

## Pattern Rule

**IF** a standard algorithm expresses the operation  
**THEN** use the algorithm or range pipeline  
**ELSE** hand-write every loop  
