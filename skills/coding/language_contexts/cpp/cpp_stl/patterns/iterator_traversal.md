...
**Confidence:** high  
**Tags:** iterators, stl, abstraction  
**Reference:** Introduction to C++ (and C) Programming; Hans Petter Langtangen; 2006-01; pp. 230-260; evidence: text  

## Pattern Rule

**IF** code should traverse a container generically  
**THEN** use iterators/ranges appropriate to the abstraction  
**ELSE** tie traversal to raw array indexes unnecessarily  
