# Task abstraction for independent work
...
## Pattern Rule
**IF** work can run independently and returns a result,  
**THEN** consider tasks/futures,  
**ELSE** raw threads may overexpose mechanics.
