# Function object for reusable behavior
...
## Pattern Rule
**IF** behavior carries state and must be passed around,  
**THEN** use a function object or lambda,  
**ELSE** global functions lack context.
...
- Absorbed variant: Boost.Bind to lambda migration
