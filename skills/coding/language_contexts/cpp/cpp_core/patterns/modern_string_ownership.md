# Modern String Ownership

**Object ID:** PAT-CPP-047  
**Object Type:** pattern  
**Category:** coding  
...
**Confidence:** high  
**Tags:** strings, modern_cpp, ownership  
**Reference:** Introduction to C++ (and C) Programming; Hans Petter Langtangen; 2006-01; pp. 49, 53, 56; evidence: text  

## Pattern Rule

**IF** text is owned by C++ code  
**THEN** prefer std::string/string_view according to lifetime  
**ELSE** default to char* for owned strings  
