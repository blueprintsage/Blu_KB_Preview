...
**IF** class data must be protected  
**THEN** keep representation private and expose behavior  
**ELSE** let external code mutate internals directly  
