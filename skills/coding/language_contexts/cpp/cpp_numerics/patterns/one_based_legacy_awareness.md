# One Based Legacy Awareness

**Object ID:** PAT-CPP-091  
**Object Type:** pattern  
**Category:** coding  
...
**Confidence:** high  
**Tags:** numerics, indexing, legacy  
**Reference:** Introduction to C++ (and C) Programming; Hans Petter Langtangen; 2006-01; pp. 84-86; evidence: text  

## Pattern Rule

**IF** a legacy numerical container uses one-based indexing  
**THEN** treat it as a local convention and isolate it  
**ELSE** mix one-based and zero-based assumptions freely  
