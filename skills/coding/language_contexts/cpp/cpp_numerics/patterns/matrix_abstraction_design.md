...
## Pattern Rule
**IF** numerical arrays need safety and expressiveness,  
**THEN** design matrix operations around dimensions and ownership,  
**ELSE** raw arrays dominate.
