...
## Pattern Rule
**IF** numerical code can work across element types,  
**THEN** template the element type,  
**ELSE** reuse is limited.
...
- Absorbed variant: Boost lexical conversion boundary
