...
**Confidence:** high  
**Tags:** memory, allocation, c, cpp  
**Reference:** Introduction to C++ (and C) Programming; Hans Petter Langtangen; 2006-01; pp. 75-81; evidence: text  

## Pattern Rule

**IF** manual memory is unavoidable  
**THEN** pair every allocation family with the matching deallocation family  
**ELSE** mix malloc/free with new/delete  
