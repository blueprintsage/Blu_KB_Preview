# Storage Order Matches Loop Order

**Object ID:** PAT-CPP-022  
**Object Type:** pattern  
**Category:** coding  
...
**Confidence:** high  
**Tags:** performance, loops, cache  
**Reference:** Introduction to C++ (and C) Programming; Hans Petter Langtangen; 2006-01; pp. 73, 86; evidence: text  

## Pattern Rule

**IF** designing nested loops over arrays  
**THEN** match loop nesting to memory layout  
**ELSE** optimize math while ignoring traversal cost  
