# Matrix Row Pointer Model

**Object ID:** PAT-CPP-092  
**Object Type:** pattern  
**Category:** coding  
...
**Confidence:** high  
**Tags:** matrix, pointers, memory  
**Reference:** Introduction to C++ (and C) Programming; Hans Petter Langtangen; 2006-01; pp. 79-81; evidence: text  

## Pattern Rule

**IF** working with double** matrices  
**THEN** distinguish row pointer table from entry storage  
**ELSE** assume double** guarantees contiguous matrix data  
