# Copy Behavior Must Be Intentional

**Object ID:** PAT-CPP-058  
**Object Type:** pattern  
**Category:** coding  
...
**Confidence:** high  
**Tags:** copy, ownership, raii  
**Reference:** Introduction to C++ (and C) Programming; Hans Petter Langtangen; 2006-01; pp. 170-230; evidence: text  

## Pattern Rule

**IF** a class owns resources  
**THEN** define or avoid copying deliberately  
**ELSE** accept accidental shallow copies  
