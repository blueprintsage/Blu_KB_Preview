...
**Confidence:** high  
**Tags:** raii, ownership, exceptions  
**Reference:** Introduction to C++ (and C) Programming; Hans Petter Langtangen; 2006-01; pp. 170-230; evidence: text  

## Pattern Rule

**IF** an object acquires a resource  
**THEN** make release automatic and exception-safe  
**ELSE** make clients remember cleanup  
