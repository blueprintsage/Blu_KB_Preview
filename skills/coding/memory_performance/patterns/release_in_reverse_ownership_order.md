# Release In Reverse Ownership Order

**Object ID:** PAT-CPP-093  
**Object Type:** pattern  
**Category:** coding  
...
**Confidence:** high  
**Tags:** memory, deallocation, c  
**Reference:** Introduction to C++ (and C) Programming; Hans Petter Langtangen; 2006-01; pp. 80-81; evidence: text  

## Pattern Rule

**IF** manually deallocating compound data  
**THEN** release owned entry storage before pointer tables  
**ELSE** free outer handles while losing inner allocation  
