# Complexity Plus Constants

**Object ID:** PAT-CPP-065  
**Object Type:** pattern  
**Category:** coding  
...
**Confidence:** high  
**Tags:** performance, complexity, numerics  
**Reference:** Introduction to C++ (and C) Programming; Hans Petter Langtangen; 2006-01; pp. 260-290; evidence: text  

## Pattern Rule

**IF** comparing implementation choices  
**THEN** consider both asymptotic behavior and constant factors  
**ELSE** trust big-O alone for numerical kernels  
