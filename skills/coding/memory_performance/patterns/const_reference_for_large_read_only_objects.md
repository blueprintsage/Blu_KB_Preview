# Const Reference For Large Read-Only Objects

**Object ID:** PAT-CPP-028  
**Object Type:** pattern  
**Category:** coding  
...
**Confidence:** high  
**Tags:** const, references, performance  
**Reference:** Introduction to C++ (and C) Programming; Hans Petter Langtangen; 2006-01; p. 90; evidence: text  

## Pattern Rule

**IF** passing a large object for reading  
**THEN** pass it as const reference  
**ELSE** copy it by value accidentally  
