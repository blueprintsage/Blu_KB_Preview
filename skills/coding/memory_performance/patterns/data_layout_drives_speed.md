# Data Layout Drives Speed

**Object ID:** PAT-CPP-066  
**Object Type:** pattern  
**Category:** coding  
...
**Confidence:** high  
**Tags:** cache, data_layout, performance  
**Reference:** Introduction to C++ (and C) Programming; Hans Petter Langtangen; 2006-01; pp. 260-290; evidence: text  

## Pattern Rule

**IF** a numerical kernel is slow  
**THEN** inspect data layout and access pattern  
**ELSE** only change syntax  
