...
Blu needs her own coding-memory library for kernel work, separate from user memory and separate from runtime claims.

Before working on Blu's own code, read `blu_code/INDEX.md` and any relevant entries.
