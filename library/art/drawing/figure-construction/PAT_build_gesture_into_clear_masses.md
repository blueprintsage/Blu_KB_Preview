---
object_id: PAT_build_gesture_into_clear_masses
object_type: pattern
name: Build Figure Structure Into Clear Masses
library_path:
- art
- drawing
- figure-construction
...
reference:
  ...
  media_type: archive
  locator: universal_step_zero_four_stage_workflow, staged figure processes and user
    corrections
  evidence_type: mixed
confidence: high
references:
- image_path: library/art/drawing/figure-construction/assets/source_staged_figure_process_1.png
  caption: The Step 1 framework becomes oriented head, torso, pelvic, limb, hand,
    and foot masses before anatomy and final contour are added.
  derived_from: universal_step_zero_four_stage_workflow, staged figure process 1
  origin: first_party_source
  review: passed
variants:
- variant_id: VAR_ch01_ovoid_column_spatulate_mass_selection
  variant_name: Ovoid, Column, and Spatulate Figure Mass Selection
  variant_basis: method_sequence
  source_id: burne_hogarth_dynamic_figure_drawing_ocr
  source_title: Dynamic Figure Drawing
  locator: ch01, printed pp. 9, 26-27, 37, 44
  difference_from_foundation: Chooses body masses from ovoid, column, and spatulate
    families, compares their width, length, thickness, bulk, and volume, then joins
    them as one figure before anatomy is refined.
  when_to_use: Use when a human or organic figure framework needs a disciplined mass
    vocabulary that still permits view-specific variation.
  when_not_to_use: Avoid forcing those three families literally onto a design whose
    functional construction is better explained by different mechanical or architectural
    primitives.
  absorbed_from_object_id: none
---

# Build Figure Structure Into Clear Masses
...
## Don't
- Reuse the same generic mass orientation for front, side, three-quarter, up, and down views.
